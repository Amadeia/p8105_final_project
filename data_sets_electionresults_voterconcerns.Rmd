...
congress_district$county = str_replace(congress_district$county,"MuCulloch","McCulloch")
...
#there appear to be 4 counties from the NY times data that aren't in the other datasets...Sterling, DeWitt, Lavaca, and McCulloch. Sterling is in dictrict 11. DeWitt is in district 34, Lavaca is 27. McCulloch is

...
merged_nyc_searches = merge(merged_searches, table_county, by="county", all=TRUE)
#there appear to be 4 counties from the NY times data that aren't in the other datasets...Sterling, De Witt, La Vaca, and McCulloch
